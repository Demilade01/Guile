...
import { HOW_IT_WORKS_STEPS, type StepItem, IMAGES } from '../../constants/index.ts';
...
export const HowItWorks = () => {
  return (
    <section className="relative w-full py-16 md:py-24 px-4 md:px-8 bg-transparent overflow-hidden">
      <div
        className="absolute inset-0 -z-10 bg-cover bg-center"
        style={{ backgroundImage: `url(${IMAGES.howItWorksBg})` }}
      />
